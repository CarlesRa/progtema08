...
public class Alumne {
    ...
    public void crearAlumne(){
        ...
        do{
            ...
            nia= Principal03.lec.nextInt();
            Principal03.lec.nextLine();
            for(int i = 0; i< Principal03.contador; i++){
                if(Principal03.alumnos[i].getNia()==nia){
        ...
        telefon= Principal03.lec.nextInt();
        Principal03.lec.nextLine();
        System.out.println();
        aux=new Alumne(); 
        aux.setNia(nia);
        ...
        Principal03.alumnos[Principal03.contador]=aux;
        Principal03.contador++;
    }
    public void crearAlumneAleatori(){
        ...
        for(int i=0; i<n; i++){
            ...
            aux=new Alumne();
            aux.setNia(Principal03.contador+1);
            aux.setNom(nom);
            aux.setCognom(cognom);
            aux.setDataNaiximent(dataNaiximent);
            aux.setGrup(grup);
    ...
    public void mostrarAlumnes(){
        ...
        cabecera();
        for(int i = 0; i< Principal03.contador; i++){
                System.out.println(Principal03.alumnos[i].toString());
        }
    }
    public void mostrarPorGrupo(){
        ...
        grupo = Principal03.lec.nextLine();
        System.out.println("\u001B[4mAlumnos del grupo: " + grupo+"\u001B[0m\n");
        cabecera();
        for(int i = 0; i< Principal03.contador; i++){
            if(Principal03.alumnos[i].getGrup().equalsIgnoreCase(grupo)){
                System.out.println(Principal03.alumnos[i].toString());
                coincidencias++;
            }
        }
    ...
    public void mostrarPorEdad(){
        ...
        edad = Principal03.lec.nextInt();
        Principal03.lec.nextLine();
        System.out.println("\u001B[4mAlumnos de " + edad + " años son:\u001B[0m\n");
        cabecera();
        for(int i = 0; i< Principal03.contador; i++){
            dia=Integer.parseInt(Principal03.alumnos[i].getDataNaiximent().substring(0,2));
            mes=Integer.parseInt(Principal03.alumnos[i].getDataNaiximent().substring(3,5));
            año=Integer.parseInt(Principal03.alumnos[i].getDataNaiximent().substring(6,10));
    ...
    public void mostrarPorApellidos(){
        ...
        apellido = Principal03.lec.nextLine();
        System.out.println("\u001B[4mlos alumnos con apellido "+apellido+" es:\u001B[0m\n");
        cabecera();
        for(int i = 0; i< Principal03.contador; i++){
            if(Principal03.alumnos[i].getCognom().equalsIgnoreCase(apellido)){
                System.out.println(Principal03.alumnos[i].toString());
                coincidencias++;
            }
        }
        ...
        for(int i = 0; i< Principal03.contador; i++){
            if(Principal03.alumnos[i].getNia()==nia){
                do{
                    ...
                    c= Principal03.lec.nextLine();
                    if(c.equalsIgnoreCase(s)){
                        System.out.print("Alumno "+"\"\u001B[33m"+ Principal03.alumnos[i].getNom()+" "+ Principal03.alumnos[i].getCognom()
                        +"\u001B[0m\""+" removido, pulse intro para continuar: ");
                        Principal03.lec.nextLine();
                        for (int j = i; j < Principal03.contador- 1; j++) {
                            Principal03.alumnos[j] = Principal03.alumnos[j+1];
                        }
                        i= Principal03.alumnos.length;
                        condicion=false;
                        Principal03.contador--;
                    }
